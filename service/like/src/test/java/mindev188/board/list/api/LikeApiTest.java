package mindev188.board.list.api;
...
public class LikeApiTest {
    ...
    void likePerformanceTest() throws InterruptedException {
        ...
        likePerformanceTest(executorService, 1112L, "pessimistic-lock-2");
        likePerformanceTest(executorService, 1113L, "optimistic-lock-1");
    }
